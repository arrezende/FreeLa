...
echo $_SESSION['userLogado'];

if(isset($_POST['enviar'])):
  if($_POST['email'] == $_SESSION['userLogado']):
...
<div class="lockscreen-wrapper">
  ...
  <div class="lockscreen-item">
    ...
    <form class="lockscreen-credentials" type="POST">
      <div class="input-group">
        <input type="text" class="form-control" placeholder="password" name="email">

        <div class="input-group-btn">
          <button type="button" class="btn" name="enviar"><i class="fa fa-arrow-right text-muted"></i></button>
        </div>
      </div>
    </form>
